...
function course(msg, name, virtuale, teams, website, professors) {
  ...
  /* convert a string into simil snakecase with -
  ...
  ${emails}
  <a href='https://csunibo.github.io/${toOurCase(name)}/'>📚Risorse: materiali, libri, prove</a>
  <a href='https://github.com/csunibo/${toOurCase(name)}/'>📂Repository GitHub delle risorse</a>`
  );
}
