  ...
  if (
    ...
    group.forEach((e, i) => {
      promises[i] = bot
        ...
        .catch((e) => {
          message(msg, `Elenco non trovato.\n(Errore: "${e}")`);
          console.error(e.stack);
        });
    });
...
function yearly(msg, command, noYear) {
  bot
    ...
    .catch((e) => {
      message(
        msg,
        `Non riesco a leggere il nome della chat, e quindi non capisco a quale annata fare riferimento.\n(Errore: "${e}")`
      );
      console.error(e.stack);
    });
}
